...
%d,s denote the experiment number in the 
function [CurrentPattern, Uel]=load_data(d,s)
...
InjectionSet = 5; % Change this to use different sets.
...
datasetno = d; objectno = s;  % this is one example only (corresponds to Case2.5)
...
%save hom_data_set5.mat Uel CurrentPattern MeasPattern